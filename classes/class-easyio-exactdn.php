...
/**
 * Enables Easy IO to filter the page content and replace image urls with ExactDN urls.
 */
class EasyIO_ExactDN extends EasyIO_Page_Parser {
	...
	function debug_message( $message ) {
		if ( function_exists( 'ewwwio_debug_message' ) ) {
			...
			easyio_debug_message( $message );
		}
	}
}

global $easyio_exactdn;
$easyio_exactdn = new EasyIO_ExactDN();
